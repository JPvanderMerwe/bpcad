...
| | |
|---|---|
| Envelope | 49.50 x 49.50 x 50.00 mm |
| Volume | 22.086 cm3 |
| Watertight | yes |
| Separate bodies | 1 |
| Triangles | 2148 |
...
Roughly **28.0 g** / **9.2 m** of 1.75 mm PETG at 100% infill.
...
|---|---|
| Supports needed | no |
| Worst overhang | 0.0 deg from vertical |
| Underside past 45 deg | 0.0 mm2 |
| ...bridged by the layer above | 0.0 mm2 |
| ...falling further | 0.0 mm2 |
| Bed contact | 921.5 mm2 |

## Feature sizes

This template declares no named features.

## Assumptions

**The request gave no dimensions, so every number in this
part was chosen by the model.** Nothing here was measured
and nothing was specified.

What it settled on: 49.50 x 49.50 x 50.00 mm, 22.086 cm3.
Check those against what you actually need before printing
it - they are a starting point, and the spec is there to be
edited.
...
Spec written by **qwen2.5-coder:7b** on machine **laptop**, 2 attempt(s), 257.3s.
