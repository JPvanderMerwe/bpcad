...
| | |
|---|---|
| Envelope | 80.00 x 40.00 x 6.00 mm |
| Volume | 18.959 cm3 |
| Watertight | yes |
| Separate bodies | 1 |
| Triangles | 3044 |
...
Roughly **24.1 g** / **7.9 m** of 1.75 mm PETG at 100% infill.
...
Spec written by **qwen2.5-coder:7b** on machine **laptop**, 1 attempt(s), 151.1s.
